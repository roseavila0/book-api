...
const dataPath = path.join(__dirname, '../data/books.json');
    ...
    const writeBooks= (book) => {
        ...
        fs.writeFileSync(dataPath,JSON.stringify(book, null,2));  //el null ayuda a que no haya cambios o reemplazos y el 2 ayuda con los espacios en el formato json.
    };
